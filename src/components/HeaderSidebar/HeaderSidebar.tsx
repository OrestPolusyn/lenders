  ...
  return (
    ...
    >
      ...
      <div className={styles.headerSidebarContent}>
        <div className='logo'>{BUSINESS_INFO.name}</div>
        <p>
          Expert mortgage solutions tailored to your needs. We're here to help you
          find the perfect home loan with the best rates and personalized service.
        </p>
        <h2>Contact Us</h2>
        <ul>
          <li>
