import { c as createAstro, d as createComponent, m as maybeRenderHead, f as addAttribute, j as renderScript, i as renderComponent, r as renderTemplate } from '../assets/astro/server.BcVv-EhL.js';
...
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  try {
    ...
    console.log(`\u2705 Loaded ${initialPosts.length} posts from WordPress`);
  } catch (error) {
